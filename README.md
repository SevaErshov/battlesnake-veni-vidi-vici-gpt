# Battlesnake HardML Expert

Этот вариант зафиксирован под runtime-модель **`expert`**.
Его удобно залить в отдельную ветку `feature/expert-safety` и деплоить как отдельную змейку для сравнения в Battlesnake.
...
По умолчанию в этом варианте стоит `expert`, потому что на синтетическом holdout он дал лучший top-1 выбор хода среди легких моделей.
