# Battlesnake HardML SVM

Этот вариант зафиксирован под runtime-модель **`svm`**.
Его удобно залить в отдельную ветку `feature/hardml-svm` и деплоить как отдельную змейку для сравнения в Battlesnake.
